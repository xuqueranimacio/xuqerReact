        ...
        <>
            ...
            <InfoSectionWrapper>
                <InfoSectionCardRight imgURL={img2}>
                    Descobreix amb nosaltres infnitat
                    de llocs! La nostra empresa t'ofereix l'oportunitat d'explorar
                    paisatges impressionants i gaudir d'activitats a l'aire lliure en
                    companyia dels nostres monitors i monitores. Des de rutes de
                    senderisme per paratges naturals fns a emocionants
                    expedicions en bicicleta de muntanya, teatres, competicions
                    d’esports, les nostres excursions estan dissenyades per a
                    satisfer els desitjos de persones de totes les edats i nivells
                    d'experiència.
